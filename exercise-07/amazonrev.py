...
#Copied function that can be used to read in the texts
...
#Convert the text in the files on a bag of words representation
...
#Design and train a neural network with two hidden layers
model = Sequential()
